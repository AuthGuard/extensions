...
public class HibernatePermissionsRepositoryTest {
    ...
    public void getAllForGroup() {
        assertThat(repository.getAllForGroup("tests", "main", Page.of(null, 20)).join()).containsOnly(first, second);
    }

    @Test
    public void getAllForNonexistentGroup() {
        assertThat(repository.getAllForGroup("nothing", "main", Page.of(null, 20)).join()).isEmpty();
    }
}